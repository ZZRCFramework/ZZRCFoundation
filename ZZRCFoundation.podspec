#
#  Be sure to run `pod spec lint ZZRCFoundation.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.author             = { "田向阳" => "tianxiangyang@zzrc.tech" }
  # Or just: s.author    = "tianxiangyang"
  # s.authors            = { "田向阳" => "tianxiangyang@zzrc.tech" }
  # s.social_media_url   = "http://twitter.com/田向阳"
  ...
  s.resource      = "ZZRCFoundation/Foundation/Main/common.db"
  ...
  # s.xcconfig = { "HEADER_SEARCH_PATHS" => "$(SDKROOT)/usr/include/libxml2" }
   ...
   s.dependency "UIDeviceIdentifier", "1.4.0"
